...
if "audio_brief" in st.session_state:
    ...
    <div id="player">
      <div id="topRow">
        ...
        <div id="trackInfo">
          <div id="trackTitle">MarketM<span style="position:relative;display:inline-block">&#x131;<span style="position:absolute;left:50%;top:0.08em;transform:translateX(-50%);width:0.17em;height:0.17em;background:#76b900;border-radius:50%;display:block"></span></span>nd Daily Brief</div>
