...
<div id="mm-ticker-wrap">
  <div id="mm-ticker-track">
    <span class="mm-ticker-inner">
      ...
      <span class="mm-ticker-sep">|</span>
      ⚠ <b>DISCLAIMER:</b> This analysis is generated by AI — AI can hallucinate facts, figures, and events that did not occur.
...
if "audio_brief" in st.session_state:
    ...
    <div id="player">
      <div id="topRow">
        ...
        <div id="trackInfo">
          <div id="trackTitle">MarketM<span style="position:relative;display:inline-block">&#x131;<span style="position:absolute;left:50%;top:0.24em;transform:translateX(-50%);width:0.17em;height:0.17em;background:#76b900;border-radius:50%;display:block"></span></span>nd Daily Brief</div>
